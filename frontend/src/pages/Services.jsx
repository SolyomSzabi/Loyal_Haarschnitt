                        ...
                        <div className="flex items-center justify-between mb-4">
                          <div className="flex items-center space-x-4">
                            <div className="flex items-center space-x-1">
                              ...
                              <span className="text-sm text-zinc-600">{service.duration} {t('common.min')}</span>
                            </div>
                            <div className="flex items-center space-x-1">
                              <span className="text-lg font-bold text-yellow-600">{t('services.from')} {service.base_price} {t('common.currency')}</span>
                            </div>
                          </div>
                        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="text-center" data-testid="service-feature-precision">
              ...
              <h3 className="text-xl font-semibold text-zinc-900 mb-3">{t('services.whatMakesSpecial.precision.title')}</h3>
            ...
            <div className="text-center" data-testid="service-feature-products">
              ...
              <h3 className="text-xl font-semibold text-zinc-900 mb-3">{t('services.whatMakesSpecial.products.title')}</h3>
              <p className="text-zinc-600">
            ...
            <div className="text-center" data-testid="service-feature-consultation">
              ...
              <h3 className="text-xl font-semibold text-zinc-900 mb-3">{t('services.whatMakesSpecial.consultation.title')}</h3>
              <p className="text-zinc-600">
